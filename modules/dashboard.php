...
<section class="dashboard-section"><div class="section-head"><h2>Pegawai dan KPI</h2><a class="btn" href="?p=kpi&section=store_recap&month=<?=e($month)?>">Detail KPI</a></div><div class="grid">
